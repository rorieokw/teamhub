                ...
                <div className="p-5 space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Get notified when assigned to a task</p>
                    </div>
                    <div className="w-14 h-8 bg-purple-600 rounded-full relative">
                      <span className="absolute top-1 right-1 w-6 h-6 bg-white rounded-full shadow-lg" />
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
